...
def enhance_attributes(api_design_id, db, filename=None):
    try:
        paths = db.paths.find({"api_design_id": api_design_id})
        components = db.components.find({"api_design_id": api_design_id})
